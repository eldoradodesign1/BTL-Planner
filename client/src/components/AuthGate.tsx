...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  if (loading) return <div className="auth-loading" aria-busy="true"><div className="brand-symbol"><img src={logoUrl} alt="Logo Mon Essentiel" /></div><span>Ouverture de votre espace ME…</span></div>;
